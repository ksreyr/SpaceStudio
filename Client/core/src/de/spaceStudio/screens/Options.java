...
import de.spaceStudio.util.GdxUtils;
    ...
    public class Options extends ScreenAdapter{
        ...
        public void show() {
            ...
            TextButton textButtonSinglePlayer = new TextButton("There's Always An Option ", sgxSkin, StyleNames.EMPHASISTEXTBUTTON);
            ...
            //Title:  Menu
            Label label = new Label("OPTIONS", sgxSkin, StyleNames.TITLELABEL);

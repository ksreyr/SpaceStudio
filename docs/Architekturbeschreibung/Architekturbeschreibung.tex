...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\linewidth]{../Modulsicht_Quellcode/Model.png}
	\caption{Model}
	\label{fig2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.6\linewidth]{../Modulsicht_Quellcode/ServicesModel.png}
	\caption{Service}
	\label{fig2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.9\linewidth]{../Modulsicht_Quellcode/Zustandsdiagramm.png}
...
Dann kann er seine Crew umverteilen. Diese fangen dann an die Section zu reparieren
in der Sie stehen.
Als nächstes wird für jede Waffe angeben, welche Section sie von dem Gegnerischem Schiff angreifen soll.
Sobald alles bestätigt ist, wird die Runde von dem Spieler beendet. Hat der Gegner, dies getan.
So werden vom Server die Änderungen validiert und die Clients erhalten die akutaliserten Werte.

\begin{figure}[!ht]
	\centering
  \includegraphics[width=0.85\textwidth]{../kampf}
	\caption{Kampf Runde}
	\label{fig:Kampf}
\end{figure}
...
%% Was ist Nötig, welche änderungen bei der globalen Anylse, welche stellen werden verändert. Welche Komponeten und was tun.

...
\title{Test Protokoll\\
 ...
 RE SWP-2}
\hypersetup{
 pdfauthor={Kevin Santiago Rey Rodriguez, Habib Mergan},
...
Konkret gab es die meisten Änderungen im Model. Erst bei der implementierung und der überprüfung der Mindestanforderungen ist uns aufgefallen, dass die Spiel züge nicht nachvollziehbar sind. Das Spiel hat nun Zustände für die Multiplayerlobby, die Spielrunde und für jede Kampfrunde. 

Die Controller wurden in der Architekturbeschreibung nur sehr wage spezifiziert. Diese wurde in der letzten Phase der Implementierung stark erweitert, weil erst die Spiel Mechanik auf dem Server umgesetzt wurde.
